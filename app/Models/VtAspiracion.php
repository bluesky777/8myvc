...
/**
 * Las columnas de `vt_aspiraciones`, tal como están en el esquema congelado.
 *
 ...
 *
 * @property array $candidatos  los candidatos a esa aspiración, con el voto en blanco añadido
 * @property mixed $votado  si quien pregunta ya votó esa aspiración
 */



class VtAspiracion extends Model {
	protected $fillable = [];
