> Este fichero es el CLAUDE.md anterior al resumen del 21 sep 2026, conservado entero. Lleva
> dentro el relato de cómo se llegó a cada regla —las fechas, los recuentos que envejecieron,
> los errores cometidos y remedidos—. El CLAUDE.md vivo son sólo las reglas; esto es el porqué.
