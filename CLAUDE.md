...
**613 rutas** (contadas con `route:list --json` el **19 sep 2026 en `.worktrees/muro`, SIN FUNDIR:
hay que recontarlas en el árbol principal el día que entren** — la que sube sobre las 612 es
