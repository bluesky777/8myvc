...
class AsignaturasController extends Controller {
	...
	public function putDatosAsignaturas()
	{
		...
		// `g.ih` es la intensidad horaria semanal del grupo, y viaja aquí porque es
		// aquí donde se puede comprobar: la pantalla de asignaturas suma la IH de las
		// asignaturas de cada grupo y la compara con ésta. Sin ella, un descuadre no
		// aparece hasta que el programa de horarios no puede colocar todas las fichas.
		$consulta = 'SELECT g.id, g.nombre, g.abrev, g.orden, gra.orden as orden_grado, g.grado_id, g.year_id, g.titular_id, g.ih,
