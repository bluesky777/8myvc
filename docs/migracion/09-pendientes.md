...
| `years.profes_can_edit_alumnos` decide más cosas de las que dice su nombre | [05 §29.1](05-codigo-muerto-y-roto.md) · [12 §20](12-larastan-nivel-7.md) | qué debe poder hacer un docente con esa bandera encendida. **Recontado el 21 ago 2026: no son dos cosas, son 25 apariciones y 19 rutas**, catorce de ellas el módulo de matrículas entero —matricular, retirar, desertar, promover, borrar la matrícula— más `alumnos/guardar-valor` y el reseteo de contraseña. No es un permiso fino: es un interruptor que entrega matrículas completo. Hoy está **apagada en los ocho años** de la copia de desarrollo, así que esas rutas son solo del superusuario; encenderla se las da de golpe a los 19 profesores. La lista la fija ahora `BanderaProfesEditaAlumnosTest` |
