...
| `GET unidades/de-asignatura-periodo` **crea** unidades con el periodo cerrado | [05 §47.1](05-codigo-muerto-y-roto.md) | qué debe devolver entonces. La pregunta no es si debe escribir —claramente no— sino que es **la pantalla con la que el profesor mira la rejilla**, así que un 400 le apaga la vista de un periodo cerrado, que es justo la que querrá consultar. Devolver vacío sin crear, o crear igual por ser unidades por defecto, cambian lo que ve la pantalla |
