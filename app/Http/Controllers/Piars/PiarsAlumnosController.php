...
class PiarsAlumnosController extends Controller {
	 ...
	 *
	 * El `if` de siempre construía la respuesta y NO la devolvía, así que la
	 * ejecución seguía y no comprobaba nada. Aquí importa de verdad: las dos
	 * rutas de documento llevan `persona.propia`, que a un Alumno le deja pasar
	 * su propio `alumno_id`. O sea que un alumno podía subir y borrar los
	 * documentos de su propio PIAR, que son cosa del psicólogo y del titular.
	 */
