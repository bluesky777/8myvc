...
| Un profesor reinicia la contraseña de TODOS los alumnos del colegio | [05 §26.1](05-codigo-muerto-y-roto.md) | si se cierra a superusuarios. Es «qué puede hacer el personal entre sí», y además **no hay ningún guard de superusuario en la API**: crear el primero es una decisión. Ningún cliente llama a esas cuatro rutas |
