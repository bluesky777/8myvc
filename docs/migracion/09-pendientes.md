...
| El lector de Tardanzas devuelve el hash bcrypt del usuario | [05 §25.4](05-codigo-muerto-y-roto.md) | si se quita del `SELECT`. Es el hash propio de quien acaba de mandar su contraseña, así que no expone a terceros — pero el lector trabaja sin red y validar contra ese hash es justo lo que necesitaría para dejar entrar al operario desconectado. Quitarlo a ciegas puede apagar aparatos montados en las puertas de los dieciséis colegios |
