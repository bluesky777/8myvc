...
```bash
docker exec 8myvc-app-1 php artisan test                       # los 417
...
docker exec 8myvc-app-1 composer run stan                      # larastan nivel 2
...
- **Larastan nivel 2**, y no baja. Lo que no se puede arreglar va anotado en
