 ...
 * @property User $user el usuario recién creado, para devolverlo junto al profesor
 */
class Profesor extends Model
{
    ...
    public static function detallado($profesor_id)
    {
        ...
        $profesor = DB::select($consulta, [$profesor_id]);
    ...
    public static function asignaturas($year_id, $profesor_id)
    {
        ...
        $asignaturas = DB::select($consulta, [':year_id' => $year_id, ':profesor_id' => $profesor_id]);
